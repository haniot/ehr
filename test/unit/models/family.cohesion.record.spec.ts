    ...
    describe('fromJSON()', () => {
        ...
        context('when the json is undefined', () => {
            it('should return the class without parameters', () => {
                ...
                assert.isUndefined(result.friendship_approval_freq, 'no friendship_approval_freq defined')
                assert.isUndefined(result.family_only_task_freq, 'no family_only_task_freq defined')
                assert.isUndefined(result.family_only_preference_freq, 'no family_only_preference_freq defined')
                assert.isUndefined(result.free_time_together_freq, 'no free_time_together_freq defined')
                assert.isUndefined(result.family_proximity_perception_freq, 'no family_proximity_perception_freq defined')
                assert.isUndefined(result.all_family_tasks_freq, 'no all_family_tasks_freq defined')
                assert.isUndefined(result.family_tasks_opportunity_freq, 'no family_tasks_opportunity_freq defined')
                assert.isUndefined(result.family_decision_support_freq, 'no family_decision_support_freq defined')
                assert.isUndefined(result.family_union_relevance_freq, 'no family_union_relevance_freq defined')
                assert.isUndefined(result.family_cohesion_result, 'no family_cohesion_result defined')
                assert.propertyVal(result, 'type', DefaultEntityMock.FAMILY_COHESION_RECORD.type)
            })
        })
